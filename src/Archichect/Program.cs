...
using Archichect.WebServing;

namespace Archichect {
    public class Program {
        public const string VERSION = "V.0.39.6";
        ...
        public static readonly Option DoScriptOption = new ProgramOption(shortname: "ds", name: "do-script", usage: "filename [parameters...]", description: "execute Archichect script");
        public static readonly Option DoScriptLoggedOption = new ProgramOption(shortname: "dl", name: "do-script-logged", usage: "scriptname", description: "execute Archichect script with log output");
        public static readonly Option DoScriptHelpOption = new ProgramOption(shortname: "ds?", name: "do-script-help", usage: "scriptname", description: "show help for Archichect script");
        ...
        public static int Main(string[] args) {
            ...
            try {
                ...
                while (program._webServer != null || program._interactiveLogFile != null || program._fileWatchers.Any()) {
                    ...
                    Console.WriteLine(value: "Type /?<enter> for help; or q<enter> for stopping Archichect.");
        ...
        private int UsageAndExit([CanBeNull] string message, GlobalContext globalContext,
            ...
            if (filter.StartsWith("file")) {
                Console.WriteLine("*** THIS SHOULD BE A HELP TEXT ABOUT Archichect input files (+, //, defines)");
                return exitValue;
            } else if (filter.StartsWith("item")) {
                Console.WriteLine("*** THIS SHOULD BE A HELP TEXT ABOUT Archichect items in general");
                Console.WriteLine(Item.ITEM_HELP);
                return exitValue;
            } else if (filter.StartsWith("dep")) {
                Console.WriteLine("*** THIS SHOULD BE A HELP TEXT ABOUT Archichect dependencies in general");
                ...
                Console.WriteLine("*** THIS SHOULD BE A HELP TEXT ABOUT Archichect item types");
                return exitValue;
            } else {
...
All messages of Archichect are written to Console.Out.
...
");
                ...
                //         you include this switch without specifying a value, Archichect
        ...
        private static void WriteVersion() {
            Log.WriteInfo(msg: "Archichect " + VERSION + " (c) HMMüller, Th.Freudenberg 2006...2017");
        }
