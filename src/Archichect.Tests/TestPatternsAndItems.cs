...
using Archichect.Reading.AssemblyReading;
...
namespace Archichect.Tests {
    ...
    public class TestPatternsAndItems {
        ...
        public void TestEmptyNamespaceInRule() {
            ...
            Item @using = graph.CreateItem(itemType, "Archichect.TestAssembly.dir1.dir2", "SomeClass", "Archichect.TestAssembly", "1.0.0.0", "", "AnotherMethod");
            Item used = graph.CreateItem(itemType, "", "NamespacelessTestClassForArchichect", "Archichect.TestAssembly", "1.0.0.0", "", "I");
            var d = graph.CreateDependency(@using, used, null, "Test", ct: 1);

            var r = CreateDependencyRule(itemType, "Archichect.TestAssembly.dir1.dir2:SomeClass:**", "-:NamespacelessTestClassForArchichect::I");
            Assert.IsTrue(r.IsMatch(d));
        }
        ...
        public void TestSimpleNamedCall() {
            ...
            var gc = new GlobalContext();
            WorkingGraph graph = gc.CurrentGraph;
            Item @using = graph.CreateItem(itemType, "", "NamespacelessTestClassForArchichect", "Archichect.TestAssembly", "1.0.0.0", "", "");
