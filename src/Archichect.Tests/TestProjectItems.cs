...
namespace Archichect.Tests {
    ...
    ! a    ---%
        ...
        //    piSimple.Configure(gc, @"{ -pf C:\PT\github\Archichect\examples\puf\PUF.dep }".Replace(" ", "\r\n"), true);
        ...
        //    piTrie.Configure(gc, @"{ -pf C:\PT\github\Archichect\examples\puf\PUF.dep }".Replace(" ", "\r\n"), true);

        //    AbstractDependencyReader rd = new DipReaderFactory().CreateReader(@"C:\PT\github\Archichect\examples\puf\PUF.dip", gc, false);
